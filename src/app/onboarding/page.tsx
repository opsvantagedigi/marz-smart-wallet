...
import { Wallet, Mail, Key, ArrowRight } from "lucide-react";
...
export default function OnboardingPage() {
  ...
  function handleSmartWallet() {
    // For now, redirect to dashboard which will handle Smart Wallet setup
    window.location.href = "/dashboard?wallet=smart";
  }

  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-[#001a1a] to-[#003333] flex items-center justify-center p-4">
