        ...
        <div className="max-w-5xl mx-auto text-center space-y-8">
          ...
          <Reveal delay={160}>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
              <Link href="/onboarding" className="px-8 py-3 rounded-lg bg-gradient-to-r from-[#007F7F] via-[#00BFFF] to-[#FFD700] text-black font-orbitron text-sm sm:text-base hover:scale-105 hover:shadow-2xl hover:shadow-cyan-400/50 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-cyan-400/50">
                Get Started
              </Link>
        ...
        <div className="max-w-2xl mx-auto">
          <Reveal>
            <GlassCard className="p-8 sm:p-12 text-center border-cyan-400/40 bg-gradient-to-br from-black/40 via-black/60 to-cyan-900/10">
              ...
              <Link href="/onboarding" className="inline-block px-8 py-3 rounded-lg bg-gradient-to-r from-[#007F7F] via-[#00BFFF] to-[#FFD700] text-black font-orbitron text-sm sm:text-base hover:scale-105 hover:shadow-2xl hover:shadow-cyan-400/50 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-cyan-400/50">
                Launch App Now
              </Link>
            </GlassCard>
          </Reveal>
